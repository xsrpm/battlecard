...
class CeldaBatalla {
  ...
  agregarCarta (carta, posBatalla) {
    ...
    this.dispCambio = CeldaBatalla.Estado.CAMBIO_POS_NO_DISPONIBLE
    if (posBatalla === CeldaBatalla.Estado.POS_BATALLA_ATAQUE) { this.dispAtaque = CeldaBatalla.Estado.ATAQUE_DISPONIBLE } else this.dispAtaque = CeldaBatalla.Estado.ATAQUE_NO_DISPONIBLE
    this.carta = carta
  }
  ...
  cambioPosicionBatallaAtaque () {
    ...
    if (res === CeldaBatalla.Estado.POS_BATALLA_ATAQUE) { this.dispAtaque = CeldaBatalla.Estado.ATAQUE_DISPONIBLE }
    return res
  }
  ...
  cambioPosicionBatallaDefensa () {
    ...
    if (res === CeldaBatalla.Estado.POS_BATALLA_DEF_ARRIBA) { this.dispAtaque = CeldaBatalla.Estado.ATAQUE_NO_DISPONIBLE }
    return res
  }
