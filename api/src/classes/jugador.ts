...
export class Jugador {
  ...
  puedeAtacarBarreras (jugadorAtacado: Jugador) {
    if (this.nCartasEnZB === 0) { return ResultadoAtacarBarrera.SIN_CARTAS_EN_ZONA_BATALLA }
  ...
  puedeAtacarCartas (jugadorAtacado: Jugador) {
    ...
    if (this.nCartasEnZB === 0) { return ResultadoAtacarCarta.SIN_CARTAS_EN_ZONA_BATALLA }
    if (jugadorAtacado.nCartasEnZB === 0) {
